...
export function LogoMarquee() {
  return (
    <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col gap-6 px-6 pb-10 sm:flex-row sm:items-center sm:gap-12">
      <p className="whitespace-pre-line text-sm text-foreground/50">
